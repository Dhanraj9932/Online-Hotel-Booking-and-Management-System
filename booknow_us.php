...
{ 
 ...
 header("location:index.php"); 
    ...
    { 
        extract($_REQUEST);
        $result=$user->booknow($checkin, $checkout, $name, $n_people , $phone, $roomname, $uid, $amt, $mode, $date);
        if($result)
        {
      ...
      <div class="well">
            ...
            <form action="" method="post" name="room_category">
               ...
               ?>
                ...
                <button type="submit" class="btn btn-lg btn-primary button" name="submit">Pay & Book</button>
