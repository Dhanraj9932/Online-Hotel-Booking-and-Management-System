        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="room1.php">Room &amp; Facilities</a></li>
...
//               ********************************************** Show Room Category***********************
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo "
                            ...
                            <div class='col-md-3'>
                                <a href='./booknow_us.php?roomname=".$row['roomname']."'><button class='btn btn-primary button'>Book Now</button> </a>
                            </div>   
                            </div>
