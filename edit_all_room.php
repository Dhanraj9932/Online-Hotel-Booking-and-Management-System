...
$sql="SELECT * FROM booking_details WHERE room_id='$id'";
          ...
          <h2><?php echo  $row['cat']?></h2>
            ...
            <form action="" method="post" name="room_category">
               ...
               <div class="form-group">
                    ...
                    <input type="text" class="datepicker" name="checkin" value="<?php echo $row['cin']?>">

                </div>
               
               <div class="form-group">
                    <label for="checkout">Check Out:</label>&nbsp;
                    <input type="text" class="datepicker" name="checkout" value="<?php echo $row['cout']?>">
                </div>
                <div class="form-group">
