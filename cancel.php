    ...
    <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <li><a href="user.php">Welcome 
                    ...
                    <li><a href="cancel.php" class="active">Cancel Bookings</a></li>
...
//               ********************************************** Show Room Category***********************
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo "
                            ...
                            <div class='col-md-3'>
                            <button type='submit' class='btn btn-lg btn-primary button' name='submit'>Cancel now</button>
                            </div>
                            </div>                      
        ...
        { 
            extract($_REQUEST);
            $result=$user->cancel($uid, $nm, $date,$bkid, $cat);
            if($result)
            {
